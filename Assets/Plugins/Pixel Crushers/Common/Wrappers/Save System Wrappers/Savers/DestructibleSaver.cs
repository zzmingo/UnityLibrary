...
namespace PixelCrushers.Wrappers
{
    ...
    /// <summary>
    /// This wrapper for PixelCrushers.DestructibleSaver keeps references intact if you switch 
    /// between the compiled assembly and source code versions of the original class.
    /// </summary>
    [AddComponentMenu("Pixel Crushers/Save System/Savers/Destructible Saver")]
