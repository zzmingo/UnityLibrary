...
namespace PixelCrushers.Wrappers
{
    ...
    /// <summary>
    /// This wrapper for PixelCrushers.SaveSystemMethods keeps references intact if you switch 
    /// between the compiled assembly and source code versions of the original class.
    /// </summary>
    [AddComponentMenu("Pixel Crushers/Save System/Misc/Save System Methods")]
